...
public class PersoneelslidTest {
    ...
    public void testToString() {
        ...
        @Test
    public void testGetLettersJos(){
        Personeelslid jos = new Personeelslid("Jos", "Mertens");
        assertEquals("M.t.J", jos.getLetters());
    }
    
    @Test
    public void testGetLettersWerner(){
        Personeelslid werner = new Personeelslid("Werner", "Goethals");
        assertEquals("G.h.W", werner.getLetters());
    }
    
    @Test
    public void testGetLettersKarel(){
        Personeelslid karel = new Personeelslid("Karel", "Staens");
        assertEquals("S.e.K", karel.getLetters());
    }
}
